...
If the mockup is going to become a real shipped component, that is a deliberate switch to the full `opencode_harness_design` loadout and the SDLC pipeline.
