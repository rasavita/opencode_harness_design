...
> Equivalent to `/design --doc-only` in the full `opencode_harness_design` loadout. Use this when running the slim `harness-lite` loadout, where the full `/design` skill is intentionally absent.
