# Concept: test/amendment-provenance-check.test.js

> Deterministic concept page (hash-cached). Not LLM prose.

## Summary

Cluster `test/amendment-provenance-check.test.js` groups **1** file(s).

## Files

- `test/amendment-provenance-check.test.js` (hash c18e9c7581aa0906)
