# Concept: test/at-first-gate-wiring-contract.test.js

> Deterministic concept page (hash-cached). Not LLM prose.

## Summary

Cluster `test/at-first-gate-wiring-contract.test.js` groups **1** file(s).

## Files

- `test/at-first-gate-wiring-contract.test.js` (hash 25dc7cdd37ef606e)
