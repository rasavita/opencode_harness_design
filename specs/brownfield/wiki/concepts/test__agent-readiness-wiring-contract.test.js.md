# Concept: test/agent-readiness-wiring-contract.test.js

> Deterministic concept page (hash-cached). Not LLM prose.

## Summary

Cluster `test/agent-readiness-wiring-contract.test.js` groups **1** file(s).

## Files

- `test/agent-readiness-wiring-contract.test.js` (hash ec59d1ded90c8e6a)
