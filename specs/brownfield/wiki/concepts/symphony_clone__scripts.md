# Concept: symphony_clone/scripts

> Deterministic concept page (hash-cached). Not LLM prose.

## Summary

Cluster `symphony_clone/scripts` groups **2** file(s).

## Files

- `symphony_clone/scripts/create-group-issue.js` (hash e6f79e2d545ee0b5)
- `symphony_clone/scripts/diagnose-linear.js` (hash 5f75c245046b8790)
