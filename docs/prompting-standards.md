...
How to write the harness's prompt surfaces (`.opencode/agents/*.md`, `.opencode/skills/*/SKILL.md`, `.opencode/commands/*`) so they get the best out of the current Claude models. Distilled from Anthropic's [prompting best practices](https://platform.opencode.com/docs/en/build-with-claude/prompt-engineering/claude-prompting-best-practices) and [Prompting Opus 5](https://platform.opencode.com/docs/en/build-with-claude/prompt-engineering/prompting-claude-opus-5).
