...
2. Start each command as a background process, capture stdout/stderr to `.opencode/state/process-{name}.log`
...
**Error Context:** Read from `.opencode/state/process-{name}.log`
