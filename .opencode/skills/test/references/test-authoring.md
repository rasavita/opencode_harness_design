...
|---|---|
| backend `stack.backend.language` is python | `.opencode/skills/code-gen/references/tests-python.md` (pytest) |
| frontend `stack.frontend` is React + TypeScript | `.opencode/skills/code-gen/references/tests-react-typescript.md` (vitest + RTL) |
