...
```bash
python3 .opencode/skills/code-map/scripts/code_index/code_index.py \
...
```bash
node .opencode/skills/code-map/scripts/import_graphify_graph.js \
...
```bash
node .opencode/skills/code-map/scripts/code_wiki.js render \
...
node .opencode/skills/code-map/scripts/code_wiki.js query --graph specs/brownfield/code-graph.json --calls <id>
node .opencode/skills/code-map/scripts/code_wiki.js query --graph specs/brownfield/code-graph.json --symbol <name>
node .opencode/skills/code-map/scripts/code_wiki.js query --graph specs/brownfield/code-graph.json --module <id>
node .opencode/skills/code-map/scripts/code_wiki.js query --graph specs/brownfield/code-graph.json --hubs
node .opencode/skills/code-map/scripts/code_wiki.js query --graph specs/brownfield/code-graph.json --cycles
```
