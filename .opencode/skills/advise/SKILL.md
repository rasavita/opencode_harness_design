...
5. Persist result to `.opencode/state/advisor-last.json` (+ append `advisor.jsonl`).

## Output

See `.opencode/agents/advisor.md` for the JSON contract (`continue` | `pivot` | `stop_for_human`).
