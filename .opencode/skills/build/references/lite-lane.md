...
If eligibility is uncertain, use the `clarify` gate (`.opencode/skills/clarify/SKILL.md`) — ask at most 3 questions, prefer recording assumptions over interrogating. If still uncertain, escalate and stop.
...
Each story file follows `.opencode/templates/story.template.md` with:
- `Group: A`
