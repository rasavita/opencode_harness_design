...
```bash
node .opencode/scripts/validate-design-decisions.js            # gated lane
node .opencode/scripts/validate-design-decisions.js --lane --auto   # headless only
```
...
9. **reasons-canvas.md** — the REASONS Canvas per
   `.opencode/skills/design/references/reasons-canvas-template.md`. `Entities`
...
Read `.opencode/skills/design/references/ui-mockups.md` and follow it. One
...
Follow `.opencode/skills/design/references/mode-11-machine-readable-artifacts.md`
