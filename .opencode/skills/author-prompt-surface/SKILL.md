...
description: Use when creating or editing .opencode/agents/*.md, .opencode/skills/*/SKILL.md, or .opencode/commands/* — apply docs/prompting-standards.md (trigger conditions, model-agnostic bodies, no reasoning-as-text, effort floors).
...
| Path | Role |
|------|------|
| `.opencode/agents/*.md` | Subagent prompts (`model:` frontmatter only for model pins) |
| `.opencode/skills/*/SKILL.md` | Skill prompts and stage workflows |
| `.opencode/commands/*` | Slash-command entrypoints |
