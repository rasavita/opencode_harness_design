...
// Claude Code caches the request prefix (system + tools + AGENTS.md + MCP
// tool surface). Editing these files mid-session busts the cache for every
// later turn. AGENTS.md documents this; this module enforces it on Write/Edit
...
function prefixCacheBlockMessage(rel) {
  return (
    ...
    `invalidates the cached prefix (AGENTS.md + tools + MCP surface) for every later turn.\n` +
