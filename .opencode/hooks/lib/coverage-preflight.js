...
const SCRIPT_REL = path.join('.opencode', 'skills', 'code-map', 'scripts', 'code_index', 'coverage_map.py');
const CACHE_REL = path.join('.opencode', 'state', 'coverage-preflight-cache.json');
