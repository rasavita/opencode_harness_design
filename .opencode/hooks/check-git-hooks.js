...
// at the copied .opencode/git-hooks/ tree. A repo created with `git init` but never
...
function warn() {
  process.stdout.write(
    ...
    'Fix: git config core.hooksPath .opencode/git-hooks && \\\n' +
    '     chmod +x .opencode/git-hooks/{pre-commit,commit-msg,prepare-commit-msg}   (or re-run /scaffold).\n'
  );
}
