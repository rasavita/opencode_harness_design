...
//
// Usage:
//   node .opencode/scripts/diagnostics-shard.js --tool tsc --from-file errors.txt
//   node .opencode/scripts/diagnostics-shard.js --tool ruff --text "..."
//   node .opencode/scripts/diagnostics-shard.js --auto --from-file capture.txt
//
// Writes:
...
function parseArgs(argv) {
  const out = {
    ...
    fromFile: null,
    text: null,
    outDir: '.opencode/state/diagnostics',
    maxPerShard: 50,
  };
