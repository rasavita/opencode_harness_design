...
#
# Usage:
#   .opencode/scripts/migration-roundtrip.sh --detect-only
#   DATABASE_URL=<disposable-db-url> .opencode/scripts/migration-roundtrip.sh
#   .opencode/scripts/migration-roundtrip.sh --ephemeral-postgres   (docker)
#
