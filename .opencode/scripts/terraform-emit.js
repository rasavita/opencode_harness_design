...
//
//   node .opencode/scripts/terraform-emit.js [--root <dir>] [--fleet <fleet.json>] [--out <file>]
//
...
function header(github) {
  return [
    '# GENERATED by .opencode/scripts/terraform-emit.js — do not edit by hand.',
    '# Source of truth: project-manifest.json#github (+ fleet.json for repo discovery).',
    '# Regenerate:  node .opencode/scripts/terraform-emit.js',
    '#',
