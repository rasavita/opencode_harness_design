...
// CLI: node .opencode/scripts/generate-attestation.js [--force] [--verify <file>] [--json]
//
...
// .opencode/attestations/<sha>.json plus an integrity-checksummed index.json.
//
...
function generateAttestation(opts = {}) {
  ...
  const attestDir = opts.attestDir || path.join(root, '.opencode', 'attestations');
