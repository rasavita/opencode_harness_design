...
// CLI: node .opencode/scripts/sensor-value-report.js [--min-runs N] [--json]
//
...
function subtractiveHint(c) {
  ...
  return ['', 'NEXT: for a candidate above, remove it, rerun a representative job, then record:',
    '  node .opencode/scripts/sensor-withhold.js record --sensor <id> --degraded <true|false> --job "<what you reran>"'];
}
