...
// CLI: node .opencode/scripts/control-budget-gate.js [--check]
// Subtractive ratchet on the harness's own control count (harness-simplification
// P0). Reads harness-manifest.json + .opencode/state/control-budget-baseline.json
...
const BASELINE = path.join(REPO, '.opencode', 'state', 'control-budget-baseline.json');
