...
// CLI: node .opencode/scripts/coupling-gate.js
...
// use), and compares it to .opencode/state/coupling-baseline.txt. The COUNT may
...
const BASELINE = path.join(REPO, '.opencode', 'state', 'coupling-baseline.txt');
