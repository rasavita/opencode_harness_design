...
// CLI: node .opencode/scripts/cycle-gate.js
// Cycle-fail ratchet (gap G8): reads specs/brownfield/code-graph.json, counts
// import cycles, and compares to .opencode/state/cycle-baseline.txt. The count may
...
const BASELINE = path.join(REPO, '.opencode', 'state', 'cycle-baseline.txt');
