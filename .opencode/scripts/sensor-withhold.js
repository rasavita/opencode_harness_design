...
// CLI: node .opencode/scripts/sensor-withhold.js record --sensor <id> --degraded <true|false> [--job "..."] [--evidence "..."]
//      node .opencode/scripts/sensor-withhold.js            # list recorded verdicts
//
