...
// CLI: node .opencode/scripts/drift-report.js
...
const MARKER = path.join(REPO, '.opencode', 'state', 'modularity-review-marker.json');
...
function modularityMarkerHubIds() {
  ...
  if (!marker) {
    process.stderr.write(
      ...
      '.opencode/state/modularity-review-marker.json. No real modularity review ' +
