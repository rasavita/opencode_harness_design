...
//
// CLI: node .opencode/scripts/record-modularity-review.js
//        [--root DIR] [--graph specs/brownfield/code-graph.json]
//        [--out .opencode/state/modularity-review-marker.json]
//        [--scope-path PATH ...]
...
const DEFAULT_OUT = path.join('.opencode', 'state', 'modularity-review-marker.json');
