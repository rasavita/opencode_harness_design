...
//
// CLI:
//   node .opencode/scripts/perf-baseline.js [--base URL] [--endpoints /a,/b]
//        [--method GET] [--body '{"k":1}'] [--content-type application/json]
//        [--samples N] [--out FILE]                          capture mode
//   node .opencode/scripts/perf-baseline.js --compare [--threshold PCT] [...]
//   node .opencode/scripts/perf-baseline.js --measure [...]   print stats only
//
