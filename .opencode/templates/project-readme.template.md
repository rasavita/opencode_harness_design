# {{PROJECT_NAME}} — OpenCode Harness Dashboard

This project was scaffolded with **OpenCode Harness Engine v5**.
...
| `.opencode/program.md` | Steer an in-flight `/auto` run by editing this |
...
| Drift cadence workflow | Scaffold with `--drift-workflow`, or copy `.opencode/templates/github-workflows/harness-drift.yml` to `.github/workflows/` |
...
| Cost/model posture | Edit `project-manifest.json`, then run `node .opencode/scripts/model-tier.js <tier> --apply .opencode/agents` |
