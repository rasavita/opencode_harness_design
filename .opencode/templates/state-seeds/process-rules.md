...
- **Rule:** after repeated workflow failures (stash races, stub-to-green, suite thrash), update process-rules and/or `.opencode/workflows/fix-diagnostics.js` / skills — do not only patch product code
