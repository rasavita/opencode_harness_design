...
2. Read `.opencode/skills/auto/SKILL.md`, `.opencode/program.md`, `.opencode/state/learned-rules.md`, `features.json`, `specs/stories/dependency-graph.md`, and every story file in this group.
...
7. Write `.opencode/state/tracker-runs/{{ group.id }}/result.json` with:
