...
|---|---|
| `stack.backend.language` is python | `.opencode/skills/gate/references/security-python.md` |
| `stack.frontend` React/TS or a Node backend | `.opencode/skills/gate/references/security-react-typescript.md` |
