...
When the spawn prompt or change set indicates a **mechanical migrate** (`specs/migrate/` present, `/refactor --mechanical`, or an explicit language/runtime port), also apply `.opencode/skills/code-gen/references/semantic-divergence.md`:
