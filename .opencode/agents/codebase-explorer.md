...
```bash
node .opencode/scripts/nav-query.js hubs         # high fan-in modules — your structural map
node .opencode/scripts/nav-query.js cycles       # circular dependencies
node .opencode/scripts/nav-query.js module <id>  # a module's members + edges
node .opencode/scripts/nav-query.js callers <id> # or: calls <id>
node .opencode/scripts/nav-query.js symbol <name> # or: lookup <name>
node .opencode/scripts/nav-query.js semantic "<question>"
```
...
- Python → `.opencode/skills/code-map/references/trace-python.md`
- Node / TypeScript / JavaScript → `.opencode/skills/code-map/references/trace-node-typescript.md`
